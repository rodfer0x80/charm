...
/* package charm-0.1.0.0 */
#ifndef VERSION_charm
#define VERSION_charm "0.1.0.0"
#endif /* VERSION_charm */
#ifndef MIN_VERSION_charm
#define MIN_VERSION_charm(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_charm */
...
#define CURRENT_COMPONENT_ID "charm-0.1.0.0-inplace-charm"
